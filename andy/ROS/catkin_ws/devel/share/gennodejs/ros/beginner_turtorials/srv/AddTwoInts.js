...
// (in-package beginner_turtorials.srv)
...
class AddTwoIntsRequest {
  ...
  static datatype() {
    ...
    return 'beginner_turtorials/AddTwoIntsRequest';
  }
...
class AddTwoIntsResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'beginner_turtorials/AddTwoIntsResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'beginner_turtorials/AddTwoInts'; }
};
