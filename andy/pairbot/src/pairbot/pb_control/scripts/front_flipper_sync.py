...
def callback_for_right_front_flipper(data):
    pub = rospy.Publisher('joint_left_front_flipper_controller/command', Float64, queue_size=10)
    pub.publish(data.data)

def callback_for_left_front_flipper(data):
    pub = rospy.Publisher('joint_right_front_flipper_controller/command', Float64, queue_size=10)
...
def listener():
    ...
    rospy.Subscriber("joint_left_front_flipper_controller/command", Float64, callback_for_left_front_flipper)
